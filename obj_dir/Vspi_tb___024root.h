...
class alignas(VL_CACHE_LINE_BYTES) Vspi_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*4:0*/ spi_tb__DOT__spi_controller__DOT__spi_clk_edges;
    CData/*0:0*/ spi_tb__DOT__spi_controller__DOT__spi_clk;
    CData/*3:0*/ spi_tb__DOT__spi_controller__DOT__clk_count;
    CData/*0:0*/ spi_tb__DOT__spi_controller__DOT__leading_edge;
    CData/*0:0*/ spi_tb__DOT__spi_controller__DOT__trailing_edge;
    CData/*7:0*/ spi_tb__DOT__spi_controller__DOT__tx_data;
    CData/*0:0*/ spi_tb__DOT__spi_controller__DOT__tx_dv;
    CData/*2:0*/ spi_tb__DOT__spi_controller__DOT__tx_bit_count;
    CData/*2:0*/ spi_tb__DOT__spi_controller__DOT__rx_bit_count;
